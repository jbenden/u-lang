...
if(NOT LLVM_CONFIG)
    ...
    llvm_set(BIN_DIR bindir)
    llvm_set(INCLUDE_DIRS includedir true)
    llvm_set(ROOT_DIR prefix true)
    llvm_set(ENABLE_ASSERTIONS assertion-mode)

    find_program(LLVM_LINK
                 NAMES llvm-link
                 PATHS ${LLVM_BIN_DIR} NO_DEFAULT_PATH
                 DOC "Path to llvm-link tool.")
    if (NOT LLVM_LINK)
      message(FATAL "Could not locate the LLVM linker in ${LLVM_BIN_DIR}")
    endif()

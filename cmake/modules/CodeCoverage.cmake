...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
    ...
    IF(COVERALLS)
    	...
    	ADD_CUSTOM_TARGET(${_targetname}
                        ...
                        COMMAND coveralls -b ${CMAKE_CURRENT_BINARY_DIR} -i ${CMAKE_SOURCE_DIR}/lib -i ${CMAKE_SOURCE_DIR}/include --exclude-lines-pattern LCOV_EXCL_LINE -nl ${_outputname}.info.cleaned -y ${CMAKE_SOURCE_DIR}/.coveralls.yml
